...
<%@page import="in.yazhini.dao.BookingDAO"%>
...
<body>
	...
	<main class="container-fluid">
		...
		List<Shopping> userBookList = (List<Shopping>) request.getAttribute("BOOKING_DETAILS");
		%>
		<table class="table table-bordered" id="bill">
			...
			<tbody>
				...
				<%
				int i = 0;
				for (Shopping order : userBookList) {
					i++;
